...
export default function SectionSignUpLogin(props) {
  return (
    <div id='section-signup-login'>
      <div
        className='border'
        style={{ backgroundColor: colors[1].backgroundColor }}
      >
        <svg
          id='shred'
          fill={colors[0].color} // colors[4].color
      ...
      <div className=''>
        ...
        {!props.user && (
          <div
            id='or'
            className='tw-italic tw-text-4xl tw-pb-10 tw-w-full tw-px-5  tw-text-left'
          >
            Or
          </div>
        )}
        ...
        <div className='tw-pb-20'>
          {props.user && (
            <Logout user={props.user} setUser={props.setUser} colors={colors} />
          )}
        </div>
      </div>
    </div>
