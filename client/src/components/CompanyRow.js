...
export default function CompanyRow(props) {
  ...
  return (
    <div
      ...
      className='tw-flex tw-items-center tw-justify-start tw-m-4'
      key={props.company._id}
    >
      <div style={nameStyle} className='compName'>
        {props.company.company_name.toUpperCase()}
      </div>
